...
#include "../../PolygenPainter/mybutton.h"
...
QT_MOC_LITERAL(6, 64, 1) // "e"
    ...
    "MyButton\0rightClicked\0\0leftClicked\0"
...
void MyButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyButton::rightClicked)) {
                *result = 0;
            }
        }
        {
            typedef void (MyButton::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyButton::leftClicked)) {
                *result = 1;
            }
        }
    }
